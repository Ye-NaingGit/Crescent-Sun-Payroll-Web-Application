...
@section('content')
    <body>
        <section class="get-in-touch">
            <h1 class="title">Create New Employees</h1>
            <div>
                @include('shared.noti')
            </div>
            <form class="contact-form row" method="POST" action="">
                ...
                <div class="form-field col-lg-6 ">
                    <input name="email" id="email" class="input-text js-input" type="text" required>
                ...
                <div class="form-field col-lg-6 ">
                    <input name="bankAccount" id="bankAccount" class="input-text js-input" type="text" required>
                ...
                <div class="form-field col-lg-6 ">
                    <label class="label" for="occupation_id" class="input-text js-input">Occupation</label>
                ...
                <div class="form-field col-lg-6 ">
                    ...
                    <textarea name="address" style="resize: none" class="input-text js-input"></textarea>
                </div>
